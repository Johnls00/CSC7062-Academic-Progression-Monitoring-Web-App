...
router.delete('/admin/student/delete-student-module/:userModuleId', ensureAuth, ensureAdmin, adminController.deleteStudentModule);
...
router.post("/admin/modules/add-module", ensureAuth, ensureAdmin, adminController.addModule);
router.delete("/admin/modules/delete-module/:id", ensureAuth, ensureAdmin, adminController.deleteModule);
